...
function mat_list_item:layout(_, width, height)
    ...
    if self._private.icon then
        table.insert(layout, base.place_widget_at(self._private.imagebox,
                                                  width / 2 - self._private.size /
                                                      2, height / 2 -
                                                      self._private.size / 2,
                                                  self._private.size,
                                                  self._private.size))
    end
    return layout
...
function mat_list_item:get_icon() return self._private.icon end
...
function mat_list_item:get_size() return self._private.size end
